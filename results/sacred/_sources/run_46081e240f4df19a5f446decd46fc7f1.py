...
def run_sequential(args, logger):
    ...
    scheme = {
        ...
        "followup_agents": {"vshape": 2, "dtype": th.long}, # selected_agents_next 
    ...
    runner.setup(scheme=scheme, groups=groups, preprocess=preprocess, mac=mac, qdifference_transformer=qdifference_transformer, planning_transformer=planning_transformer,timeseries_ode_model=timeseries_ode_model)
    ...
    while runner.t_env <= args.t_max:
        ...
        if (runner.t_env - last_test_T) / args.test_interval >= 1.0:
            ...
            for _ in range(n_test_runs):
                ...
                runner.run_wolfpack_attacker(test_mode=True)    # wolfpack 攻击测试
