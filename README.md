...
This repository considers the implementation of the paper "Wolfpack Adversarial Attack for Robust Multi-Agent Reinforcement Learning" which has been accepted to ICML 2025, and is available at [https://arxiv.org/abs/2502.02834](https://arxiv.org/abs/2502.02844). This repository is based on the PyMARL implementation of MARL baselines([https://github.com/oxwhirl/pymarl](https://github.com/oxwhirl/pymarl)).
